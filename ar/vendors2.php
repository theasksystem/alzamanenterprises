      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" id="sign-up-form">
          <div class="register-wrap text-right">
            <h3 class="fsz-25 ptb-15"><strong>Seller </strong> <span class="light-font">Request Form</span></h3>
            <p>بع مع الزمان المشاريع </p>
            ...
            <form name="sign_up" id="sign_up" method="post" class="register-form row  pt-50" >
              <div class="row">
              <div class="col-md-6 col-sm-12 col-xs-12"><div class="form-group">
                <input type="text" name="user_name" id="user_name" value="<?=$_SESSION['user_name']; ?>" class="form-control" placeholder="الاسم" required>
              </div></div>
              <div class="col-md-6 col-sm-12 col-xs-12"><div class="form-group">
                <input type="text" name="store" id="store" value="<?=$_SESSION['store']; ?>" class="form-control" placeholder="اسم المتجر" required>
              </div></div>
              <div class="col-md-6 col-sm-12 col-xs-12"><div class="form-group">
                <input type="email" name="user_email" id="user_email" value="<?=$_SESSION['user_email']; ?>" class="form-control" placeholder="البريد الالكتروني" required>
              </div></div>
              <div class="col-md-6 col-sm-12 col-xs-12"><div class="form-group">
                <input type="number" name="user_mobile" id="user_mobile" value="<?=$_SESSION['user_mobile']; ?>" class="form-control" placeholder="رقم الجوال" required>
              </div></div>
            
              <div class="col-md-6 col-sm-12 col-xs-12"><div class="form-group pt-15">
                <button type="submit" class="btn theme-btn-2" id="sign-up2"> <b>تقديم الطلب</b> </button>
                <label class="forgot-pw fsz-12 float-right"><a href="vendors" class="clr-txt-2 pw" id="login"> <strong>تسجيل الدخول </strong> هل انت مشترك معنا سابقا؟</a> </label>
              </div></div>
