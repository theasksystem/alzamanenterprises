...
<?php include 'menu.php'; ?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>NEW ORDERS</h1>
                    <ol class="breadcrumb">
                        <li><a href="home.php"><i class="fa fa-dashboard"></i>Home</a><a href="#;"><li class="active">new orders</li></a></li>
...
$query = $conn->prepare("select user_id,id,created_at,status from cart_orders WHERE status = 'pending' and id IN(select order_id from cart_order_item where pid IN(select id from products where user_id='".$_SESSION['VENDOR_ID']."')) order by id desc");
