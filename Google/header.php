...
//cart query 
$cartquery = $conn->prepare("select count(*) as cartcount, sum(price) as total,sum(qty) as totalqty from cart where un_id = '".$_SESSION['UNIQUEID']."'");
$cartquery->execute();
      ...
      <div class="logo-head">
          <div class="desktop-none">
              <div id="mySidenav" class="sidenav">
                 ...
                 <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a> <a href="<?= $WebsiteUrl.'/'; ?>"><img src="<?= $WebsiteUrl.'/'; ?>images/logo.png"></a> 
			 ...
			 $tab2->execute();
			  ...
			  ?>
				...
				?>
                  <a href="<?=$catLink; ?>" class="has-sub-m1 accordion"><?=$category['name_en']; ?> <?php if($subcategory2->rowCount() != 0){ ?><i class="fa fa-caret-down"></i><?php } ?></a>
              ...
              <span  onclick="openNav()"><i class="fa fa-bars barss" aria-hidden="true"></i></span>
             </div>
          ...
          <div class="login-list">
            <ul>
                        ...
                        <li class="login-p"><a href="javascript:;"><?=$_SESSION['LOGIN_NAME']; ?> <i class="fas fa-caret-down"></i></a>
                      ...
                      <li><a href="<?= $WebsiteUrl.'/'; ?>cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Cart (<?=$carttopcount; ?>)</a></li>
                      <?php }else{ ?>
                      <li><a href="javascript:;"><i class="fa fa-cart-plus" aria-hidden="true"></i> <span class="mobile-none-2">Cart</span></a></li>
                      <?php } ?>
                      
                      <li class="google"><a class="mobile-none-2" href="javascript:;"> EN </a><span class="white-color"> | </span><a href="<?= $arb_url; ?>"> عربي </a></li>
            </ul>
          </div>
      </div>
  </div>
