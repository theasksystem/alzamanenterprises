...
if (isset($_GET['visible'])) {
     $result = $conn->prepare("update  state set visible = :visible  where id = :id");
	 $result->bindParam(':visible', $_GET['visible'], PDO::PARAM_INT);
	 $result->bindParam(':id', $id, PDO::PARAM_INT);
	 $result->execute();
	 echo "<script>window.location='state_list.php';</script>";
}

if (isset($_GET['delete']) == 'y')
{
   	$delCenter = $conn->prepare("DELETE FROM `state` WHERE `id` = :id");
...
<?php include 'menu.php'; ?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>State List</h1>
                    <ol class="breadcrumb">
                        <li><a href="add_state.php" title="ADD NEW"><img src="img/plus.png" height="50" width="50" /></a></li>
                                           ...
                                           <td class="center">
                                            ...
                                            <td class="center">
                                                <span style="float: left;">
                                                    <a href="add_state.php?id=<?php echo base64_encode($row['id']); ?>&edit=y" title="EDIT"><img src="img/edit.png" height="30" width="30" /></a> <a onClick="return confirm('Sure you want to delete this record.');"
