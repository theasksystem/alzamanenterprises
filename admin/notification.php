...
if (isset($_GET['visible'])) {
     $result = $conn->prepare("update  notification set visible = :visible  where id = :id");
...
<html>
    <head>
        ...
        <title>All | Notification List</title>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <table id="example1" width="100%" class="table table-bordered table-striped">
                               ...
                               <?php
								$i=0;
                                     $query = $conn->prepare("select * from  notification order by id desc");
										$query->execute();
                                           ...
                                           <td class="center">
                                            ...
                                            <td class="center">
                                                <span style="float: left;">
                                                    <a href="add_notification.php?id=<?php echo base64_encode($row['id']); ?>&edit=y" title="EDIT"><img src="img/edit.png" height="30" width="30" /></a> 
                                                    <!--<a onClick="return confirm('Sure you want to delete this record.');"-->
