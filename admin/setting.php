...
$st->bindValue(':adm_id', $_SESSION['USER_ID'], PDO::PARAM_STR);
$st->execute();
              ...
              <div class="box box-primary">
                <form role="form" method="post" action="" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                          <div class="col-md-3 text-center"> <img src="uploads/<?php echo $detail['image']; ?>" id="uploadPreview" width="150" height="150" ></div>
                        </div>
                      </div>
              		<div class="form-group">
                    <div class="row">
