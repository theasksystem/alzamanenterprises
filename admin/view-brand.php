...
if (isset($_GET['status'])) {
     $result = $conn->prepare("UPDATE `products_brand` SET `status` = :status WHERE `id` = :id");
...
{
   	 $delQuery = $conn->prepare("DELETE FROM `products_brand` WHERE `id` = :id");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Brand List</h1>
      <ol class="breadcrumb">
        <li><a href="add_brand.php" title="ADD NEW"><img src="img/plus.png" height="50" width="50" /></a></li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <tbody>
              <?php
				...
				$i=1;
					...
					$query = $conn->prepare("SELECT * FROM `products_brand` ORDER BY `id` DESC");
					$query->execute();
              ...
              <tr>
                ...
                <td class="center"><?php echo $row['brand']; ?><br>
                ...
                <td class="center"><span style="float: left;"> <a href="add_brand.php?id=<?php echo base64_encode($row['id']); ?>&edit=y" title="EDIT"><img src="img/edit.png" height="30" width="30" /></a> <a onClick="return confirm('Sure you want to delete this record.');"
