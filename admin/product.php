...
$i=0;
$query = $conn->prepare("select * from products where user_id=1 order by id desc");
$query->execute();
$productCount = $query->rowCount();

$productActiveCount2 = $conn->prepare("select * from products where user_id=1 and status = 1 ");
$productActiveCount2->execute();
$productActiveCount = $productActiveCount2->rowCount();

$productInactiveCount2 = $conn->prepare("select * from products where user_id=1 and status = 0");
...
<title>All | Admin Products list</title>
    ...
    <section class="content">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Admin Products List <button class="btn btn-primary" style="margin-left:10px">Total Products - <?=$productCount; ?></button>
