...
if (isset($_GET['visible'])) {
     $result = $conn->prepare("update  country set visible = :visible  where id = :id");
	 $result->bindParam(':visible', $_GET['visible'], PDO::PARAM_INT);
	 $result->bindParam(':id', $id, PDO::PARAM_INT);
	 $result->execute();
	 echo "<script>window.location='country_list.php';</script>";
}

if (isset($_GET['delete']) == 'y')
{
   	$delCenter = $conn->prepare("DELETE FROM `country` WHERE `id` = :id");
...
<?php include 'menu.php'; ?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>Country List</h1>
                    <ol class="breadcrumb">
                        <li><a href="add_country.php" title="ADD NEW"><img src="img/plus.png" height="50" width="50" /></a></li>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <table id="example1" width="100%" class="table table-bordered table-striped">
                               ...
                               <?php
								$i=0;
                                     $query = $conn->prepare("select * from  country order by id desc");
										$query->execute();
                               ...
                               ?>
										...
										<tr>
                                           ...
                                           <td class="center"><?php echo $row['country_code']; ?></td>
                                           ...
                                           <td class="center">
                                            ...
                                            <td class="center">
                                                <span style="float: left;">
                                                    <a href="add_country.php?id=<?php echo base64_encode($row['id']); ?>&edit=y" title="EDIT"><img src="img/edit.png" height="30" width="30" /></a> <a onClick="return confirm('Sure you want to delete this record.');"
