...
<?php include 'menu.php'; ?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="home.php"><i class="fa fa-dashboard"></i>Home</a><a href="#;"><li class="active">On The Way Orders</li></a></li>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <?php if (isset($msg)) echo $msg; ?>
                            <h3 class="box-title">On The Way Orders</h3>
                        </div>
                        <!-- /.box-header -->
...
<?php
$i=1;
$query = $conn->prepare("select c.id,c.status,c.created_at,c.user_id,c.address_id,c.total, p.user_id as vendorId from cart_orders c LEFT JOIN products p ON p.id = c.pid  WHERE c.status = 'on the way' order by id desc");
