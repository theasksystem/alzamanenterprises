...
<?php include 'menu.php'; ?>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="home.php"><i class="fa fa-dashboard"></i>Home</a><a href="#;"><li class="active">Orders History</li></a></li>
...
<?php
$i = 1;
$query = $conn->prepare("select c.id,c.status,c.created_at,c.user_id,c.total, p.user_id as vendorId from cart_orders c LEFT JOIN products p ON p.id = c.pid  WHERE c.status = 'completed' order by id desc");
