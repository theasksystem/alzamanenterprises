      ...
      <?php include('dashboard-left.php'); ?>
        <div class="col-md-9 col-sm-12 col-xs-12" id="sign-in-form">
          <div class="login-wrap product-in" style="background: #F1F3F6 !important;">
            ...
            <h3 class="fsz-25 ptb-15"><span class="light-font">Profile </span> <strong>Setting </strong> </h3>
                    <form action="" name="" method="post" enctype="multipart/form-data">
                      <div class="row">
                        
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="single-input">
                            <input type="text" name="name" placeholder="Name" value="<?=$userData['name']; ?>" required>
                          </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="single-input">
                            <input type="text" name="lastname" placeholder="Last Name(optional)" value="<?=$userData['lastname']; ?>">
                          </div>
                        </div>
                        <!--<div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="single-input">
                            <input type="text" name="cname" placeholder="Company name(optional)"  value="<?=$userData['cname']; ?>">
                          </div>
                        </div>-->
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="single-input">
                            <input type="email" name="email" placeholder="Email address" value="<?=$userData['email']; ?>" required>
                          </div>
                        </div>
           ...
           <div class="col-md-3 col-sm-12 col-xs-12">      
                  <div class="single-input">     
                        <input type="number" name="pdd" id="pdd" class="form-control" placeholder="Date(05)" value="<?php echo $userData['pdd']; ?>" required>
                  </div>
            </div>
            
            <div class="col-md-3 col-sm-12 col-xs-12">      
                  <div class="single-input">     
                        <input type="number" name="pyy" id="pyy" class="form-control" placeholder="Year(1990)" value="<?php echo $userData['pyy']; ?>" required>
                  </div>
            </div>
                        
                        <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="single-input">
                          <img src="adminuploads/user/<?php echo $userData['image']; ?>" id="uploadPreview" width="150" height="150" >
                        </div>
                      </div>
						<div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="single-input">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <div class="single-input">
                            ...
                            <input type="submit" name="update" value="Update Profile" class="checkout-btn">
                          </div>
                        </div>
                      </div>
                    </form>
