...
if(isset($_POST['update']))
{
	...
	elseif($pass!=$cpass){
	 ...
	 $errmsg = 'Password and Confirm Password Didnot Match..';
	  ...
	  $stmt = $conn->prepare("update `tbl_admin` set `password` = '$pass' where `id` ='$uid'");
      $stmt->execute();
...
<div class="main-dv-sec">
  <div class="heading-main">
    <h2><strong><a href="<?= $WebsiteUrl.'/'; ?>">Home</a></strong>  / <span>Change Password Vendor</span></h2>
  </div>
          ...
          <div class="register-wrap">
            ...
            <form name="sign_up" id="sign_up" method="post" class="register-form row  pt-50 second_form" >
              ...
              <div class="col-md-12 col-sm-12 col-xs-12"><div class="form-group pt-15">
                <input type="submit" name="update" class="btn theme-btn-2" id="sign-up2" value="UPDATE PASSWORD" style="background-color: goldenrod !important;
